...
npm exec --ignore-scripts --package=./verahelm-decision-envelope-0.10.1.tgz -- verahelm-envelope demo
```
...
Upgrades are explicit: replace both occurrences of `0.10.1`, reverify the new
