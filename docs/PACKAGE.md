...
npm exec --ignore-scripts --package=./verahelm-decision-envelope-0.8.0.tgz -- verahelm-envelope demo
```
...
Upgrades are explicit: replace both occurrences of `0.8.0`, reverify the new
