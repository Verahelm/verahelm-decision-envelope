...
| Verifier and integration kit | `0.10.1` | CLI, verifier, package, fixtures, documentation, and adapters |
| GitHub Action | release tag `v0.10.1` | Action inputs, outputs, runtime, and exit behavior |
