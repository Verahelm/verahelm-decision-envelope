...
| Verifier and integration kit | `0.10.0` | CLI, verifier, package, fixtures, documentation, and adapters |
| GitHub Action | release tag `v0.10.0` | Action inputs, outputs, runtime, and exit behavior |
