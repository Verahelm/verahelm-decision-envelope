...
assert.match(documentation, /npm exec --yes --ignore-scripts --package=https:\/\/github\.com\/Verahelm\/verahelm-decision-envelope\/releases\/download\/v0\.10\.1\/verahelm-decision-envelope-0\.10\.1\.tgz/);
