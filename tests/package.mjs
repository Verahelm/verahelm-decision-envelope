...
assert.match(documentation, /npm exec --yes --ignore-scripts --package=https:\/\/github\.com\/Verahelm\/verahelm-decision-envelope\/releases\/download\/v0\.8\.0\/verahelm-decision-envelope-0\.8\.0\.tgz/);
